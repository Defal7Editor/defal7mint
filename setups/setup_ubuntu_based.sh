...
sudo apt install openssh-server vinagre tightvncserver joystick jstest-gtk stacer filezilla samba steam wine bleachbit openjdk-14-jdk ffmpeg git rabbitvcs-cli flameshot default-jdk playonlinux glances screen gimp keepassxc grub-customizer atom
sudo apt full-upgrade
sudo apt autoremove
